$(document).ready(function () {
 ...
 // area creation
 $(document).on("click", "#vehicle_add_button", function (e) {
    e.preventDefault();
    var formData = $("#vehicle_form").serialize();
    $.ajax({
      url: base_url + "Admin/vehicle/add_vehicle",
      type: "POST",
      data: formData,
      dataType: "json",
      success: function (data) {
        if (data != "") {
          if (data.response == "success") {
            ...
            $("#vehicle-list").load(location.href + " #vehicle-list>*", "");
