            ...
            <div class="card">
                ...
                <div class="card-header pb-0">
                    ...
                    <div class="d-lg-flex mt-4">
                        <div>
                            <h4 class="mb-2"><?= $fetch_stock->stock_id ?></h4>
                        </div>
                        <div class="ms-lg-5">
                            <h4 class="mb-2"><?= $fetch_stock->stock_date ?></h4>
                        </div>
                        <div class="ms-lg-5">
                            <h4 class="mb-2"><?= $fetch_stock->user_name ?></h4>
                        </div>
                        <div class="ms-lg-5">
                            <h4 class="mb-2"><?= $fetch_stock->driver_name ?></h4>
                        </div>
                        <div class="ms-lg-5">
                            <h4 class="mb-2"><?= $fetch_stock->vehicle_number ?></h4>
                        </div>
                ...
                <div class="card-body px-0 pb-0">
                    <form id="item_filter_form">
                        ...
                        <input type="hidden" name="stock_id" value="<?= $fetch_stock->stock_id ?>">
                                ...
                                <table class="table table-flush" id="add-stock">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th class="  text-uppercase text-secondary text-xs font-weight-bolder ">Net weight</th>
