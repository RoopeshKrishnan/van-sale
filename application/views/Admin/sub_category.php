        ...
        <div class="col-12">
            <div class="card">
                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                ...
                                <button type="button" class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#sub_category_model">+&nbsp; Add <?= $page_title ?></button>

                                <div class="modal fade" id="sub_category_model" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="sub_category_form" action="">
                                                    <div class="row mt-3">
                                                        <div class="col-12 ">
                                                        ...
                                                        <div class="col-12 ">
                                                            <div class="input-group input-group-dynamic">
                                                                ...
                                                                <input class="  form-control" name="sub_category" id="sub_category" type="text" />
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" id="sub_category_add_button" class="btn bg-gradient-primary btn-sm">Add</button>
                                            </div>
                                            </form>
                ...
                <?php if (!$fetch_sub_category->num_rows() > 0) {
                    echo '<p class="text-center font-weight-bold mb-0">No Sub category added</p>';
                } else { ?>
                    <div class="card-body px-0 pb-0">
                        <div class="table-responsive">
                            <table class="table table-flush" id="sub_category-list">
...
<script>
    ...
    if (document.getElementById('sub_category-list')) {
        const dataTableSearch = new simpleDatatables.DataTable("#sub_category-list", {
            searchable: true,
            fixedHeight: false,
            perPage: 7
        });
