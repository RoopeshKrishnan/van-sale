                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                ...
                                <button type="button" class="btn bg-gradient-primary btn-sm mb-0" data-bs-toggle="modal" data-bs-target="#tax_model">+&nbsp; Add <?= $page_title ?></button>

                                <div class="modal fade" id="tax_model" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" id="tax_add_button" class="btn bg-gradient-primary btn-sm">Add</button>
                                            </div>
                                            </form>
                ...
                <?php if (!$fetch_tax->num_rows() > 0) {
                    ...
                    <div class="card-body px-0 pb-0">
                        <div class="table-responsive">
                            <table class="table table-flush" id="tax-list">
                                <thead class="thead-light">
                                    <tr>
                                        <th class="  text-uppercase text-secondary  ">sl/no</th>
                                        <th class="  text-uppercase text-secondary  ">Tax type</th>
                                        <th class="text-uppercase text-primary text-xxs font-weight-bolder opacity-7">Tax  </th>
                                        <th class="text-uppercase text-primary text-xxs font-weight-bolder opacity-7">Tax name </th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?= $row->tax ?></p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?= $row->tax_name ?></p>
                                            </td>
                                            <td>
...
<script>
        if (document.getElementById('tax_type_id')) {
        var element = document.getElementById('tax_type_id');
        const example = new Choices(element, {
            searchEnabled: false
        });
    };

    if (document.getElementById('tax-list')) {
        const dataTableSearch = new simpleDatatables.DataTable("#tax-list", {
            searchable: true,
            fixedHeight: false,
            perPage: 7
        });
